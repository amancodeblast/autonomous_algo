...
class Object {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('class_num')) {
        this.class_num = initObj.class_num
      }
      else {
        this.class_num = 0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [class_num]
    bufferOffset = _serializer.int32(obj.class_num, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [class_num]
    data.class_num = _deserializer.int32(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    if (msg.class_num !== undefined) {
      resolved.class_num = msg.class_num;
    }
    else {
      resolved.class_num = 0
    }
